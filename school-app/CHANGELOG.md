...
- [#5](https://github.com/devdis-io/react-material-dashboard/issues/5) Updated to @material-ui to `4.0.0-beta`
...
- [#2](https://github.com/devdis-io/react-material-dashboard/pull/2) Fixed `ProductCard` component description height
