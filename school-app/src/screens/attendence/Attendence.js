...
const rows = [
  createData("Sujay", 305, 100, 67, 33),
  createData("Ishanvi", 452, 100, 91, 9),
  createData("Sai", 262, 100, 100, 0),
  createData("Hanvija", 159, 100, 75, 25),
  createData("Sahwik", 356, 100, 49, 51),
  createData("Kavitha", 408, 100, 87, 13),
  createData("Koshik", 237, 100, 67, 33),
  createData("Tejansh", 375, 100, 94, 6),
  createData("Neha", 518, 100, 65, 20),
  createData("Ritjwik", 392, 100, 98, 2),
  createData("Devanshi", 318, 100, 81, 19),
  createData("Purvika", 360, 100, 83, 17),
  createData("Mani", 437, 100, 77, 23)
];
                      ...
                      .map((row, index) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <TableCell align="right">
                              {(row.presentdays / row.totaldays) * 100}
                            </TableCell>
                          </TableRow>
                        );
                      })}
